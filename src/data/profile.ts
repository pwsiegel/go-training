...
import type { EnginePrefs, PlayDefaults, Role, UserDoc } from './model';
...
export async function setEnginePrefs(uid: string, enginePrefs: EnginePrefs): Promise<void> {
  await updateDoc(doc(db, 'users', uid), { enginePrefs });
}
